...
import br.com.sergioluigi.personalfinancialcontrol.application.usecase.SaveCreditCard;
...
public class SaveCreditCardImpl implements SaveCreditCard {
    ...
    public CreditCardModel execute(String username, CreditCardModel creditCardModel) {
        ...
        isCreditCardUniqueByNameImpl.check(creditCardModel.getName(), username);
